...
type Requisition struct {
	...
	Isopen                      BoolFromFloat `json:"isOpen" sql:"isOpen"`
...
func RequisitionFromRow(rows *sql.Rows) (ICMEntity, error) {
	...
	err := rows.Scan(
		...
		&r.Estkz_Concat,
		&r.ReleaseIndicator,
		&r.ReleaseIndicatorName,
		&r.ReleaseStatus,
		&r.ReleaseStrategy,
		&r.PurchasingGroup,
		&r.PurchasingGroupName,
		&r.CreatedBy,
		&r.CreationDate,
		&r.Requisitioner,
		&r.ShortText,
		...
		&r.Plant,
		&r.PlantName,
		&r.PlantPurchOrganization,
		&r.PlantPurchOrganizationName,
		&r.PlantCompanyCode,
		&r.StorageLocation,
		&r.ReqTrackingNumber,
		&r.MaterialGroup,
		...
		&r.InvoiceReceipt,
		&r.VendorCode,
		&r.DesiredVendorCountryKey,
		&r.VendorName1,
		&r.DesiredVendorName2,
		&r.DesiredVendorCreatedBy,
		&r.VendorOneTimeAccount,
		&r.DesiredVendorTradingPartner,
		&r.FixedVendor,
		&r.FixedVendorCountryKey,
		&r.FixedVendorName1,
		&r.FixedVendorName2,
		&r.FixedVendorCreatedBy,
		&r.FixedVendorOneTimeAccount,
		&r.FixedVendorTrdingPartner,
		&r.PurchOrganization,
		&r.PurchOrganizationName,
		&r.PurchasingInfoRec,
		&r.Ebeln,
		&r.Ebelp,
		&r.PurchaseOrderDate,
		...
		&r.FunctionalArea,
		&r.Grant,
		&r.PreqProcessingState,
		&r.TotalValUponRelease,
		&r.Version,
		&r.ProcuringPlant,
		&r.Prctr,
		&r.Isopen,
