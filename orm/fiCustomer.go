...
type FICustomer struct {
	...
	PostedOn           time.Time `json:"Posted On" sql:"Posted On|pk"`
	Ledger             string    `json:"Ledger" sql:"Ledger|pk"`
	LedgerLine         string    `json:"Ledger Line" sql:"Ledger Line|pk"`

	CreatedOn time.Time `json:"Created On" sql:"Created On"`
	...
	ClearedOn        time.Time `json:"Cleared On" sql:"Cleared On"`
	...
	BaselineDate             time.Time `json:"Baseline Date" sql:"Baseline Date"`
	...
	PaymentDays1 int32  `json:"Payment Days 1" sql:"Payment Days 1"`
	PaymentDays2 int32  `json:"Payment Days 2" sql:"Payment Days 2"`
	PaymentDays3 int32  `json:"Payment Days 3" sql:"Payment Days 3"`
	...
	SalesOrderCount               int32     `json:"SO Count" sql:"SO Count"`
