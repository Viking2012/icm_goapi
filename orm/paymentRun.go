...
type PaymentRun struct {
	...
	RunDate                       NullTime `json:"Run Date" sql:"Run Date"`
	...
	PaymentDocumentPostingDate    NullTime `json:"Payment Document Posting Date" sql:"Payment Document Posting Date"`
	...
	BaselinePaymentDate           NullTime `json:"Baseline Payment Date" sql:"Baseline Payment Date"`
