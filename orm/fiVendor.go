...
type FIVendor struct {
	...
	ClearingDate                      time.Time     `json:"Clearing Date" sql:"Clearing Date"`
	...
	EntryDate                         time.Time     `json:"Entry Date" sql:"Entry Date"`
	...
	BaselineDateForDueDateCalculation time.Time     `json:"Baseline Date for Due Date Calculation" sql:"Baseline Date for Due Date Calculation"`
	PaymentTermsKey                   string        `json:"Payment Terms Key" sql:"Payment Terms Key"`
	CashDiscountDays1                 int32         `json:"Cash discount days 1" sql:"Cash discount days 1"`
	CashDiscountDays2                 int32         `json:"Cash discount days 2" sql:"Cash discount days 2"`
	NetPaymentTerms                   int32         `json:"Net Payment Terms" sql:"Net Payment Terms"`
	...
	FinalDueDate                      time.Time     `json:"Final Due Date" sql:"Final Due Date"`
	PoCount                           int32         `json:"PO Count" sql:"PO Count"`
	...
	DaysSinceVendorCreation           int32         `json:"Days Since Vendor Creation" sql:"Days Since Vendor Creation"`
	Avg_DaysSinceVendorCreation       float64       `json:"Avg_Days Since Vendor Creation" sql:"Avg_Days Since Vendor Creation"`
	Avgdays20                         int32         `json:"20% of AvgDays" sql:"20% of AvgDays"`
...
type FIVendorFlags struct {
	...
	Consinvvendor              bool `json:"ConsInvVendor" sql:"ConsInvVendor"`
